<template>
  <div class="max-w-5xl mx-auto">
    ...
    <div v-for="project in projects"
      ...
      <div>
        <div class="lg:-mt-1 flex items-center gap-8 flex-wrap mb-3">
          <NuxtLink :to="project.link" target="blank">
            <h2 class="text-lg font-semibold flex gap-2 flex-wrap items-center group">
              {{ project.title }}
              <svg aria-hidden="true" class="transition group-hover:translate-x-1 group-hover:-translate-y-1 size-4 stroke-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
              </svg>
          </h2>
          </NuxtLink>
          <NuxtLink v-if="project.github" :to="project.github" title="GitHub" target="blank">
            <svg class="size-5 fill-black dark:fill-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <div v-if="project.technos" class="flex gap-2 mb-2">
          <span v-for="techno in project.technos" 
