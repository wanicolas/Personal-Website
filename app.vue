<template>
  ...
  >
    ...
    <div
      class="min-h-dvh flex flex-col justify-between px-4 pt-8 pb-6 sm:px-12"
    >
      <header
        class="max-w-6xl mx-auto w-full mb-20 md:mb-32 lg:mb-40 text-black dark:text-white"
      >
      ...
      >
        ...
        >
          <span
            class="underline sm:no-underline hover:underline underline-offset-4 mr-2"
          >
            {{
              route.name === "a-propos"
                ? "Voir mes projets"
          ...
          <svg
            class="hidden size-7 sm:block animateSVG fill-black dark:fill-white"
            aria-hidden="true"
            fill="none"
            viewBox="0 0 24 24"
            stroke-width="1.5"
